...
public class TimeUtils {
    ...
    private static long milliseconds2Unit(long milliseconds, ConstUtil.TimeUnit unit) {
        switch (unit) {
            case MSEC:
                return milliseconds / ConstUtil.MSEC;
            case SEC:
                return milliseconds / ConstUtil.SEC;
            case MIN:
                return milliseconds / ConstUtil.MIN;
            case HOUR:
                return milliseconds / ConstUtil.HOUR;
            case DAY:
                return milliseconds / ConstUtil.DAY;
        }
        return -1;
    }
    ...
    public static String getCurTimeYear() {
        return date2String(new Date(), new SimpleDateFormat("yyyy"));
    }
    /**
     * 获取与当前时间的差（单位：unit）
